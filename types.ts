...
// Add type declarations for Vite-like environment variables.
// This allows accessing them via `import.meta.env` with type safety.
// Assumes the environment is configured with these variables (e.g., in a .env file).
declare global {
